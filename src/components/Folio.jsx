        ...
        <div className='container-fluid'>
            ...
            <div className='row justify-content-center border-bottom'>
                <div className='header-text col-12 col-xl-5 col-lg-5 col-md-6 col-sm-7 pt-xl-5 pt-lg-5 pt-md-5 text-center'>
                    ...
                    <h1>I'm <span className='text-decoration-underline underline fw-bold'>Ifechukwu Max-Oti</span>.</h1>

                    <p className='fs-6 mt-xl-4 mt-lg-4 mt-md-4'>A front-end developer passionate <br></br> about building asssessible web apps that users love.</p>
